...
## Aggiornamenti 2026-02-17
- UI: migliorata responsivit� mobile (padding, tabs scroll, iframe height).
...
## Aggiornamenti 2026-02-17
- Automation: aggiunta sezione entit� consumi extra-safe e consumo extra-safe kWh in forecast.
...
## Aggiornamenti 2026-02-17
- Extra-safe: log storico anche per le entit� extra-safe (kWh cresce).
...
## Aggiornamenti 2026-02-17
- Logiche apprese: consumo casa ora esclude entit� extra-safe.
...
## 2026-02-20
- MQTT: aggiornamenti pi� rapidi (publish 5s, cache 10s).
...
## 2026-02-22
- Extra SAFE: blocco extra aggiuntivo quando il target non � raggiungibile; avviso UI nelle previsioni.
## 2026-02-22
